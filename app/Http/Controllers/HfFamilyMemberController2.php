...
class HfFamilyMemberController2 extends Controller
{
...

    {
        ...
        ->join('hf_family_member_academies','hf_family_member_academies.family_member_id','hf_family_members.id')
...

    {
        ...
        ->join('hf_family_member_goals','hf_family_member_goals.family_member_id','hf_family_members.id')
        ->join('hf_family_member_other_courses','hf_family_member_other_courses.family_member_id','hf_family_members.id')
        ->join('hf_family_member_academy_majors','hf_family_member_academy_majors.id','hf_academic_details.major')
